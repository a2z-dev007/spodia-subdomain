...
export default async function ContactPage({ params }: Props) {
  ...
  return (
    <HotelPageShell entityKey={entityKey}>
      ...
      {/* 1. Hero Section */}
      <section className="relative w-full flex flex-col items-center justify-center overflow-hidden pt-24 pb-12 min-h-[400px] h-[52vh] max-h-[550px]">
        <Image 
        ...
        <div className="relative z-10 text-center px-6 max-w-[1000px]">
          ...
          <div className="flex flex-row flex-nowrap items-center justify-start sm:justify-center gap-3 overflow-x-auto scrollbar-hide w-full max-w-full pb-2 px-2">
      ...
      <section className="py-24 px-6 md:px-12 max-w-[1440px] mx-auto w-full">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center gap-3 bg-orange-50 px-5 py-2 rounded-full mb-4">
            ...
            <span className="text-[#FF9530] font-black uppercase tracking-widest text-sm">Reach Out</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-gray-900">Contact Details</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm flex items-start gap-6">
              ...
              <div>
                <h4 className="text-sm font-black text-gray-400 uppercase tracking-widest mb-2">📍 {name}</h4>
            ...
            {/* Phones */}
            <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm flex flex-col sm:flex-row items-start gap-6">
              <div className="w-14 h-14 bg-orange-50 rounded-2xl flex items-center justify-center shrink-0">
              ...
              <div className="flex flex-col gap-6 w-full">
                ...
                <div>
                  <h4 className="text-sm font-black text-gray-400 uppercase tracking-widest mb-1">📞 Inquiries</h4>
            ...
            <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm flex flex-col sm:flex-row items-start gap-6">
              ...
              <div className="flex flex-col gap-6 w-full">
                <div>
                  ...
                  <p className="text-lg font-bold text-gray-900 break-all">bookings@{name.toLowerCase().replace(/\s/g, "")}.com</p>
                </div>
                <div>
                  <h4 className="text-sm font-black text-gray-400 uppercase tracking-widest mb-1">✉️ Support</h4>
                  <p className="text-lg font-bold text-gray-900 break-all">support@{name.toLowerCase().replace(/\s/g, "")}.com</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6 bg-gray-50 border-t border-gray-100 relative overflow-hidden">
        ...
        <div className="max-w-[1440px] md:px-6 mx-auto w-full relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">Send a Message</h2>
            <p className="text-gray-600 text-lg font-medium">Have a question? We'd love to hear from you.</p>
          </div>
          
          <div className="bg-white rounded-[40px] p-8 md:p-12 border border-gray-100 shadow-xl">
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                
                {/* Name Input */}
                <div className="relative group">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-4 mb-2 block">Full Name *</label>
                  <div className="relative flex items-center">
                    <div className="absolute left-4 text-gray-400 group-focus-within:text-[#FF9530] transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    </div>
                    <input required type="text" placeholder="John Doe" className="w-full bg-white border border-gray-200 rounded-2xl py-4 pr-4 text-gray-900 font-bold focus:border-[#FF9530] focus:ring-4 focus:ring-orange-50 transition-all outline-none" style={{ paddingLeft: '3.5rem' }} />
                  </div>
                </div>

                {/* Email Input */}
                <div className="relative group">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-4 mb-2 block">Email Address *</label>
                  <div className="relative flex items-center">
                    <div className="absolute left-4 text-gray-400 group-focus-within:text-[#FF9530] transition-colors">
                      <Mail className="w-5 h-5" strokeWidth={2.5} />
                    </div>
                    <input required type="email" placeholder="john@example.com" className="w-full bg-white border border-gray-200 rounded-2xl py-4 pr-4 text-gray-900 font-bold focus:border-[#FF9530] focus:ring-4 focus:ring-orange-50 transition-all outline-none" style={{ paddingLeft: '3.5rem' }} />
                  </div>
                </div>

                {/* Phone Input */}
                <div className="relative group">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-4 mb-2 block">Phone Number</label>
                  <div className="relative flex items-center">
                    <div className="absolute left-4 text-gray-400 group-focus-within:text-[#FF9530] transition-colors">
                      <Phone className="w-5 h-5" strokeWidth={2.5} />
                    </div>
                    <input type="tel" placeholder="+91 98765 43210" className="w-full bg-white border border-gray-200 rounded-2xl py-4 pr-4 text-gray-900 font-bold focus:border-[#FF9530] focus:ring-4 focus:ring-orange-50 transition-all outline-none" style={{ paddingLeft: '3.5rem' }} />
                  </div>
                </div>

                {/* Inquiry Type Select */}
                <div className="relative group">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-4 mb-2 block">Inquiry Type</label>
                  <div className="relative flex items-center">
                    <select className="w-full bg-white border border-gray-200 rounded-2xl py-4 pr-12 text-gray-900 font-bold focus:border-[#FF9530] focus:ring-4 focus:ring-orange-50 transition-all outline-none appearance-none cursor-pointer" style={{ paddingLeft: '1.25rem' }}>
              ...
              {/* Message Textarea */}
              <div className="relative group">
                <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-4 mb-2 block">Your Message (Max 500 characters)</label>
                <div className="relative">
                  <div className="absolute left-4 top-5 text-gray-400 group-focus-within:text-[#FF9530] transition-colors">
                    <MessageSquare className="w-5 h-5" strokeWidth={2.5} />
                  </div>
                  <textarea maxLength={500} rows={5} placeholder="How can we assist you today?" className="w-full bg-white border border-gray-200 rounded-2xl py-4 pr-4 text-gray-900 font-bold focus:border-[#FF9530] focus:ring-4 focus:ring-orange-50 transition-all outline-none resize-none" style={{ paddingLeft: '3.5rem' }}></textarea>
                </div>
              </div>
              
              {/* Submit Action */}
              <div className="pt-4 space-y-5">
                <button type="button" className="w-full bg-[#0A0A0A] hover:bg-[#FF9530] text-white px-8 py-5 rounded-2xl font-black text-lg uppercase tracking-wider transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-3 shadow-xl hover:shadow-[#FF9530]/30 group">
                  <span>Send Message</span>
                  <Send className="w-5 h-5 group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
                </button>
                <p className="text-[11px] text-gray-400 font-bold text-center uppercase tracking-widest">
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Business Hours</h2>
            <p className="text-gray-600 text-lg md:text-xl font-medium">When you can reach our administrative teams.</p>
          </div>
          
          <div className="w-full bg-white rounded-[40px] border border-gray-100 shadow-xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              {[
                ...
                <div key={idx} className={`flex flex-col sm:flex-row sm:items-center justify-between p-6 md:p-8 rounded-3xl border transition-all duration-300 ${item.active ? 'bg-orange-50/50 border-orange-200 shadow-sm' : 'bg-gray-50/50 border-gray-100 hover:bg-gray-50'}`}>
                  <div className="flex items-center gap-5 mb-4 sm:mb-0">
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl shadow-sm ${item.active ? 'bg-white' : 'bg-white border border-gray-100'}`}>
                      {item.icon}
                    </div>
                    <div>
                      <h4 className="text-xl md:text-2xl font-black text-gray-900">{item.day}</h4>
                      {item.active && <p className="text-xs font-bold text-[#FF9530] uppercase tracking-widest mt-1">Primary Hours</p>}
                    </div>
                  </div>
                  <div className={`px-6 py-3 rounded-xl inline-block font-black tracking-wide ${item.active ? 'bg-[#FF9530] text-white shadow-md' : 'bg-white text-gray-700 border border-gray-200'}`}>
                    {item.hours}
                  </div>
                </div>
              ))}
