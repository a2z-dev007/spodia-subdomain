...
const FAQPage = ({ params }: { params: Promise<{ entityKey: string }> }) => {
      ...
      items: [
        {
          ...
          a: `Cancellations and modifications for ${name} can be managed via 'My Bookings' according to property cancellation policies.`,
        },
        {
          id: "b2",
          q: "Is advance payment required?",
          a: "A minimal booking deposit or online payment secures your reservation instantly. Pay balance upon arrival.",
        },
        {
          id: "b3",
          q: "Is butler or room service available?",
          a: `Yes, ${name} provides 24/7 in-room dining and guest service assistance.`,
        },
        {
          id: "b4",
          q: "What payment methods are accepted?",
          a: "We accept all major Credit/Debit Cards, Net Banking, UPI (Google Pay, PhonePe, Paytm), and Razorpay.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: "Yes, airport and railway station pickup/drop-off can be arranged upon request with our front desk.",
        },
        {
          id: "a2",
          q: "Is high-speed Wi-Fi complimentary?",
          a: "Complimentary high-speed fiber Wi-Fi is available across all guest rooms and public areas.",
        },
        {
          id: "a3",
          q: "Are dining options available on-site?",
          a: `Yes, ${name} features authentic multi-cuisine dining options with room service availability.`,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: "Standard check-in is 12:00 PM and check-out is 11:00 AM. Early check-in or late check-out is subject to availability.",
        },
        {
          id: "p2",
          q: "What ID documents are required at check-in?",
          a: "All guests must present a valid government-issued photo ID (Aadhaar, Passport, Driving License).",
        },
        {
          id: "p3",
          q: "Are pets allowed at the property?",
          a: "Pet policies vary by room category. Please contact reception prior to arrival if traveling with pets.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: `${name} is located at ${location}.`,
        },
        {
          id: "l2",
          q: "Is parking available for guests?",
          a: "Yes, complimentary secured guest parking is available on-site.",
        },
      ],
    },
  ];
  ...
  return (
    <HotelPageShell entityKey={entityKey}>
            ...
            {faqCategories.map((cat) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <cat.icon
                    className={`w-5 h-5 ${activeCategory === cat.id ? "text-white" : "text-[#FF9530]"}`}
                  />
                  <span className="text-sm">{cat.title}</span>
                </div>
                <ChevronRight
                  className={`w-4 h-4 ${activeCategory === cat.id ? "text-white" : "text-gray-400"}`}
                />
              </button>
            ))}
          </div>
                  ...
                  {cat.items.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span
                            className={`text-base sm:text-lg font-bold pr-2 ${isOpen ? "text-[#FF9530]" : "text-gray-900"}`}
                          >
                            {item.q}
                          </span>
                          <div
                            className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-transform duration-300 ${isOpen ? "bg-[#FF9530] text-white rotate-180" : "bg-gray-100 text-gray-600"}`}
                          >
                            {isOpen ? (
            ...
            {filteredFaqs.length === 0 && (
              <div className="py-16 text-center bg-gray-50 rounded-3xl border border-gray-200/70 p-8">
                ...
                <p className="text-gray-500 text-sm font-medium">
                  Try searching for alternative terms or contact our support
                  team.
                </p>
                <button
                  onClick={() => {
      ...
      <section className="pt-12 pb-8 sm:py-16 px-4 sm:px-8 bg-gray-50">
        <div className="max-w-[1400px] mx-auto">
          <div className="bg-gray-900 rounded-[32px] sm:rounded-[36px] p-6 sm:p-12 md:p-16 relative overflow-hidden text-white shadow-2xl">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-gray-300 text-sm sm:text-base font-medium mb-8 leading-relaxed max-w-[500px]">
                  Our dedicated guest support team is available 24/7 to assist
                  you with special requests, room customization, or direct
                  booking queries.
                </p>
                <a
                  href={`/hotels/${entityKey}/contact`}
                  className="inline-flex items-center justify-center sm:justify-start w-full sm:w-auto gap-3 bg-gradient-to-r from-[#FF9530] to-[#FF8000] text-white px-6 py-4 sm:px-8 sm:py-4 rounded-2xl font-black text-sm sm:text-base shadow-xl shadow-orange-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
              ...
              <div className="space-y-4">
                <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-2xl flex items-center gap-3 sm:gap-5 hover:bg-white/10 transition-all">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FF9530]/20 rounded-xl flex items-center justify-center shrink-0">
                    <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-[#FF9530]" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest truncate">
                      Call Reservations 24/7
                    </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-2xl flex items-center gap-3 sm:gap-5 hover:bg-white/10 transition-all">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FF9530]/20 rounded-xl flex items-center justify-center shrink-0">
                    <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-[#FF9530]" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest truncate">
                      Email Guest Support
